...
METRIC_AXES: tuple[MetricAxis, ...] = ("key", "step", "value")
...
EXPERIMENT_METRIC_QUERY_PATH = "/api/experiments/{experiment_id}/metrics/query"
"""POST a :class:`MetricQueryRequest` to read one experiment's masked cells."""

EXPERIMENT_METRIC_WRITE_PATH = "/api/experiments/{experiment_id}/metrics/write"
"""POST a :class:`MetricQueryRequest` (with ``write`` set) to assign the mask."""

METRIC_RANK_PATH = "/api/metrics/rank"
