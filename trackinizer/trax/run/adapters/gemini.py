...
class GeminiAdapter:
    ...
    def _tmp_dir(self) -> Path:
        ...
        return Path.home() / ".gemini" / "tmp"  # noqa: TID251 -- vendor fixed path, not ours (AGENTS.md rule 3)  # house-ignore[xdg-literal] -- Vendor CLI's fixed home path, not ours (AGENTS.md rule 3).
