...
type _TimeoutType = float | _NoTimeoutType | None

AUTH_METHOD_NAME: Final[dict[int, str]]
BUILTIN_TYPE_NAME_MAP: Final[dict[str, int]]
ARRAY_TYPES: Final[set[int]]
BUILTIN_TYPE_OID_MAP: Final[dict[int, str]]
ENCODINGS_MAP: Final[dict[str, str]]
NO_TIMEOUT: Final[_NoTimeoutType]
SYNC_MESSAGE: Final[bytes]
FLUSH_MESSAGE: Final[bytes]
...
class BaseProtocol(CoreProtocol, Generic[_Record]):
    ...
    async def bind(
        ...
        portal_name: str,
        timeout: _TimeoutType,  # noqa: ASYNC109 -- Mirrors upstream timeout parameter.
    ) -> Any: ...
    @overload
    ...
    async def close(self, timeout: _TimeoutType) -> None: ...  # noqa: ASYNC109 -- Mirrors upstream timeout parameter.
    ...
    async def copy_in(
        ...
        data: object,
        records: object,
        record_stmt: PreparedStatementState,
        timeout: _TimeoutType,  # noqa: ASYNC109 -- Mirrors upstream timeout parameter.
    ) -> str: ...
    async def copy_out(
        self,
    ...
    async def close_portal(self, portal_name: str, timeout: _TimeoutType) -> None: ...  # noqa: ASYNC109 -- Mirrors upstream timeout parameter.
    async def query(self, query: object, timeout: _TimeoutType) -> str: ...  # noqa: ASYNC109 -- Mirrors upstream timeout parameter.
